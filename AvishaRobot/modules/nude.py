...
EVAA = [
    [
        InlineKeyboardButton(text="ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ", url=f"https://t.me/Ur_Music_Robot?startgroup=true"),
    ],
]
...
async def nudes(_,message):
    ...
    await message.reply_photo(x.json()["content"]["url"], caption=f"❖ ɴᴜᴅᴇ ᴘɪᴄs ʙʏ ➥ ˹ ʀɪsʜυ ʙσᴛ ˼", reply_markup=InlineKeyboardMarkup(EVAA),)
